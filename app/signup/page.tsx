  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 relative overflow-hidden">
      ...
      <FloatingElement delay={2} className="bottom-40 left-40">
        <Gift className="w-5 h-5 text-pink-400/60" />
      </FloatingElement>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400">
              انضم إلينا واكتشف عالم التسوق الممتع
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pr-10 h-12 bg-gray-50/80 dark:bg-gray-800/80 border-gray-200 dark:border-gray-700 rounded-2xl focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 ${
                      fieldErrors.name ? 'border-red-500 focus:ring-red-500/20' : ''
                    }`}
                  />
                  {fieldErrors.name && (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    disabled={isLoading || !!success}
                    className={`px-10 h-12 bg-gray-50/80 dark:bg-gray-800/80 border-gray-200 dark:border-gray-700 rounded-2xl focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 ${
              ...
              >
                <Label htmlFor="confirmPassword" className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 block">
                  تأكيد كلمة المرور
                </Label>
                <div className="relative">
                  <Lock className="absolute right-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400" />
                  <Input
                    ...
                    disabled={isLoading || !!success}
                    className={`px-10 h-12 bg-gray-50/80 dark:bg-gray-800/80 border-gray-200 dark:border-gray-700 rounded-2xl focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 ${
                      fieldErrors.confirmPassword ? 'border-red-500 focus:ring-red-500/20' : ''
                    }`}
                  />
                  <Button
                    variant="ghost"
              ...
              >
                <Button
                  ...
                  className="w-full h-12 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50"
                  disabled={isLoading || !!success || !acceptTerms}
                >
                  {isLoading ? (
